 ...
 * The position can be advanced along the path, and can be converted into an (x,
 * y) coordinate.
 * 
 * Has three components that make up the position: the path that the object is
 * on, the segment
...
public class PathPosition {
	...
	private List<Point> path; // List of path coordinates for current path
	 ...
	 * @param path
	 */
	PathPosition(List<Point> points) { // Initializes variables
	...
	public Point getPos() {
		...
		return new Point(ballX, ballY); // returns new position
	}
