...
public class Game implements Runnable {
    ...
    private PathPoints line; // path Points
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (state == GameState.SETUP) {
                ...
                // Do not advance the state here. The 'draw' method will advance the state after
                // it draws.
            }

            else if (state == GameState.WAIT) {
                // Wait 1/10th a second. This code is not ideal, we'll explore a better way
                // soon.
    ...
    public void draw(Graphics g) {
        ...
        int[] xPos = new int[] { 0, 64, 118, 251, 298, 344, 396, 416, 437, 459, 460, 498, 542, 600, 600, 568, 535, 509,
                490, 481, 456, 414, 345, 287, 227, 98, 0 };
        int[] yPos = new int[] { 329, 316, 291, 189, 163, 154, 165, 186, 233, 344, 364, 415, 444, 461, 410, 396, 372,
                331, 226, 195, 151, 117, 105, 117, 143, 244, 280 };
